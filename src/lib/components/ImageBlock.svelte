<script>
  ...
  onMount(async () => {
    resizedBase64 = await resizeBase64Img(base64, 700); // 100은 원하는 너비입니다.
  });
  ...
  <div class="rounded-lg shadow-2xl">
      <div class="grid grid-cols-1 grid-flow-row-dense">
          ...
          <div class="bg-white rounded-b-lg shadow-xl col-span-1 text-left p-3 font-code text-md">
            <div class="flex justify-between">
              <img class="rounded-md" in:slide out:slide style="height: {height}" src={resizedBase64} alt="test" />
              <p out:fade bind:this={text}>asdf<br>asdf<br>asdf<br>asdf<br>asdf<br>asdf<br>asdf<br>asdf<br>asdf<br>asdf<br>asdf<br></p>
            </div>
        </div>
      </div>
  </div>
